...
class AzureSpeechRecognitionFlutter {
  static const MethodChannel _channel =
  MethodChannel('azure_speech_recognition');

  static final AzureSpeechRecognitionFlutter _azureSpeechRecognition =
  AzureSpeechRecognitionFlutter._internal();

  factory AzureSpeechRecognitionFlutter() => _azureSpeechRecognition;
  ...
  AzureSpeechRecognitionFlutter.initialize(String subKey, String region,
